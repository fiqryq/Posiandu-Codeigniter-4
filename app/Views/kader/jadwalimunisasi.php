                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= base_url('/kader/editimunisasi/' . $id); ?>" action="POST">
                                <div class="form-group">
                                        ...
                                        <input type="text" id="imunisasi" class="form-control" name="imunisasi" value="<?= $k['nama_imunisasi']; ?>">
                                    </div>
                                        <div class="form-group">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <div>
                            <a href="<?= base_url('kader/deleteImunisasi/' . $id) ?>" class="btn btn-danger">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
